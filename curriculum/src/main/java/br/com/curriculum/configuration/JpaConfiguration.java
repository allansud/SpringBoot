package br.com.curriculum.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "br.com.curriculum.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "br.com.curriculum.domain" });
